...
/*******************************************************************************
                          MAIN APPICATION
*******************************************************************************/
int OS_SVC_CALCULATE(uint32_t a, uint32_t b,uint32_t Operation){
...
int main(void)
{
	...
	/****************************************************
	 *      CALLING THE OS SVC CALCULATE SERVICES       *
	 ****************************************************/
	AdditionResult = OS_SVC_CALCULATE(5, 5, SVC_ADDITION_OPERATION);
	SubstractionResult = OS_SVC_CALCULATE(5, 5, SVC_SUBSTRACTION_OPERATION);
	MultplicationResult = OS_SVC_CALCULATE(5, 5, SVC_MULTPLICATION_OPERATION);
	while(1);
}
